...
Оцени пригодность КАЖДОГО для рекламного ролика. Лучшее фото: машина ЦЕЛИКОМ в кадре, БЕЗ чужих водяных знаков/логотипов других салонов, чёткое, светлое, красивый ракурс (перед/три четверти). Худшее: обрезанная машина, чужие водяные знаки, тёмное, размытое, документ/скрин, только деталь.
Верни ТОЛЬКО JSON: {"order":[индексы от лучшего к худшему], "reject":[индексы с чужими водяными знаками или мусором]}.` },
    ];
