...
• Ролик про конкретные ЗАПЧАСТИ из каталога (кузовные, оптика, двигатель...) → make_short (theme=категория; тут реальные фото товара). ВАЖНО: каталог запчастей сейчас содержит ТОЛЬКО BMW. Если Эдо просит запчасти другой марки (Geely, Li Auto, Mercedes...) — СРАЗУ скажи, что в каталоге пока только BMW, и предложи: сделать по BMW ИЛИ добавить позиции нужной марки в таблицу. НЕ запускай ролик по чужой марке молча. В theme передавай и марку, и категорию, если названы (напр. «BMW оптика»).
